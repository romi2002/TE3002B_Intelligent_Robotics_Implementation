...
"""autogenerated by genpy from puzzlebot_controller/MoveActionResult.msg. Do not edit."""
import codecs
import sys
...
class MoveActionResult(genpy.Message):
  ...
  _type = "puzzlebot_controller/MoveActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','puzzlebot_controller/MoveResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.result is None:
        self.result = puzzlebot_controller.msg.MoveResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = puzzlebot_controller.msg.MoveResult()
