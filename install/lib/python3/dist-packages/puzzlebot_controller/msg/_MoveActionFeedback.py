...
"""autogenerated by genpy from puzzlebot_controller/MoveActionFeedback.msg. Do not edit."""
import codecs
import sys
...
class MoveActionFeedback(genpy.Message):
  _md5sum = "48a9245f93cac355688ec6590018d330"
  _type = "puzzlebot_controller/MoveActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','puzzlebot_controller/MoveFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.feedback is None:
        self.feedback = puzzlebot_controller.msg.MoveFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = puzzlebot_controller.msg.MoveFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self
      buff.write(_get_struct_2d().pack(_x.feedback.distance_to_target, _x.feedback.angle_to_target))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.feedback.distance_to_target, _x.feedback.angle_to_target,) = _get_struct_2d().unpack(str[start:end])
      return self
