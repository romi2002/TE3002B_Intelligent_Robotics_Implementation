...
def image_callback(msg):
    ...
    for i, mask in enumerate(masks):
        ...
        if(len(color_contours)>0):
            ...
            for contour in color_contours:
                ...
                #rospy.loginfo('color: {}, a:{}, r:{}'.format(color_names_list[i], area,radius))
                if area > areaMax:
                    areaMax = area
                    contourMax = contour
                    colorMax = color_names_list[i]
    ...
    if areaMax > 1000:
        ...
        color_detected_pub.publish(colorMax)
